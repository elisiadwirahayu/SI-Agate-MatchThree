...
public class BoardManager : MonoBehaviour
{
    ...
    // membuat BoardManager sebagai singleton
    ...
    // menukar posisi tile pada board
    ...
    private void ProcessMatches()
    {
        ...
        // stop locking jika tidak ada match ditemukan
    ...
    public List<TileController> GetAllMatches()
    {
        ...
        for (int x = 0; x < size.x; x++)
        {
            for (int y = 0; y < size.y; y++)
            {
                ...
                // beralih ke next tile jika tidak match
                ...
                {
                    // hanya menambahkan satu yang belum ditambahkan
            ...
            for (int y = 0; y < size.y; y++)
            {
                if (tiles[x, y].IsDestroyed)
                {
                    ...
                    for (int i = y + 1; i < size.y; i++)
                    {
                        ...
                        // jika tile ini sudah berada drop list, tambah drop range nya
                        if (droppingTiles.ContainsKey(tiles[x, i]))
                        {
                            droppingTiles[tiles[x, i]]++;
                        }
                        // jika tidak di drop list, tambahkan sbuah drop range
                        else
                        {
    ...
    private IEnumerator RepositionTiles(System.Action onCompleted)
    {
        ...
        for (int x = 0; x < size.x; x++)
        {
            for (int y = 0; y < size.y; y++)
            {
                ...
                // skip jika sudah berada di posisi
    ...
    // mengambil indeks dari tile yang dicari pada double array tiles
    ...
    // mengambil posisi tile di indeks yang dicari pada ruang 2D game
