...
public class TileController : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        // mengecek apakah tile sudah dipilih
        if (isSelected)
        {
            Deselect();
        }
        else
        {
            ...
            {
                // mengecek apakah ini sebuah adjacent tiles
                ...
                // jika bukan adjacent kemudian change selected
                else
                {
                    previousSelected.Deselect();
                    Select();
    ...
    // mengatur tile yang di select dan deselect
    ...
    // menganimasikan gerakan pada object
    ...
    // mengecek antara kedua tile sebelum dilakukan swap
    ...
    // mengecek apakah terdapat match atau tidak

    // mengambil semua tile dengan ID yang sama pada satu arah
    ...
    // menggabungkan hasil dari fungsi satu arah menjadi satu baris (atas dan bawah menjadi vertikal)
    ...
    // menggabungkan fungsi satu baris dan mereturn hasil dari baris vertikal dan baris horizontal
